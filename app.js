...
const SUBJECT_SUBTOPICS = {
  "010": ["01001 International Law: Conventions, Agreements, Organizations", "01002 Airworthiness, Aircraft Nationality, and Registration Marks", "01004 Personnel Licensing", "01005 Rules of the Air", "01006 Aircraft Operations", "01007 Air Traffic Services (ATS) and Air Traffic Management (ATM)", "01008 Aeronautical Information Service (AIS)", "01009 Aerodromes", "01010 Facilitation", "01011 Search and Rescue (SAR)", "01012 Security", "01013 Aircraft Accident and Incident Investigation"],
  "021": ["021-01 System Design, Loads, Stresses, Maintenance", "021-02 Airframe", "021-03 Hydraulics", "021-04 Landing Gear, Wheels, Tyres, Brakes", "021-05 Flight Controls", "021-06 Pneumatics – Pressurisation and Air Conditioning Systems", "021-07 Anti-icing and De-icing Systems", "021-08 Fuel System", "021-09 Electrics", "021-10 Piston Engines", "021-11 Turbine Engines", "021-12 Protection and Detection Systems", "021-13 Oxygen Systems"],
  "022": ["022-01 Sensors and Instruments", "022-02 Measurement of Air Data Parameters", "022-03 Magnetism – Direct Reading Compass and Flux Valve", "022-04 Gyroscopic Instruments", "022-05 Inertial Navigation", "022-06 Aeroplane: Automatic Flight Control Systems", "022-08 Trims – Yaw Damper – Flight Envelope Protection", "022-09 Autothrust – Automatic Thrust Control System", "022-10 Communication Systems", "022-11 Flight Management System (FMS) / Flight Management and Guidance System (FMGS)", "022-12 Alerting Systems, Proximity Systems", "022-13 Integrated Instruments – Electronic Displays", "022-14 Maintenance, Monitoring and Recording Systems", "022-15 Digital Circuits and Computers"],
  "031": ["031-01 Purpose of Mass and Balance Considerations", "031-02 Loading", "031-04 Mass and Balance Details of Aircraft", "031-05 Determination of CG Position", "031-06 Cargo Handling"],
  "032": ["032-01 General", "032-02 (C2.23A) Applicable Operational Requirements Performance Class B – Theory", "032-03 (C2.23A) Applicable Operational Requirements Performance Class B – Use of Aeroplane Performance Data for Single and Multi-engine Aeroplanes", "032-04 (C5.25A) Applicable Operational Requirements Performance Class A – Theory", "032-05 (C5.25A) Applicable Operational Requirements Performance Class A – Use of Aeroplane Performance Data"],
  "033": ["033-01 Flight Planning for VFR Flights", "033-02 Flight Planning for IFR Flights", "033-03 Fuel Planning – CAT.OP.MPA.106 and CAT.OP.MPA.150 plus AMC1, 2 and 3", "033-04 Pre-flight Preparation", "033-05 ICAO Flight Plan (ATS Flight Plan (FPL))", "033-06 Flight Monitoring and In-flight Re-planning"],
  "040": ["040-01 Human Factors Basic Concepts", "040-02 Basics of Aviation Physiology and Health Maintenance", "040-03 Basic Aviation Psychology"],
  "050": ["050-01 The Atmosphere", "050-02 Wind", "050-03 Thermodynamics", "050-04 Clouds and Fog", "050-05 Precipitation", "050-06 Air Masses and Fronts", "050-07 Pressure Systems", "050-08 Climatology", "050-09 Flight Hazards", "050-10 Meteorological Information"],
  "061": ["061-01 Basics of Navigation", "061-02 Visual Flight Rules (VFR) Navigation", "061-03 Great Circles and Rhumb Lines", "061-04 Charts", "061-05 Time"],
  "062": ["062-01 Basic Radio Propagation Theory", "062-02 Radio Aids", "062-03 Radar", "062-06 Global Navigation Satellite Systems (GNSSs)", "062-07 Performance Based Navigation (PBN)"],
  "070": ["071-01 General Requirements", "071-02 Special Operational Procedures and Hazards (General Aspects)", "071-04 Specialised Operations"],
  "081": ["081-01 Subsonic Aerodynamics", "081-02 High Speed Aerodynamics", "081-03 Stability, Mach Tuck and Upset Prevention and Recovery", "081-04 Stability", "081-05 Control", "081-06 Limitations", "081-07 Propellers", "081-08 Flight Mechanics"],
  "090": ["090-01 Concepts", "090-02 General Operating Procedures", "090-03 Relevant Weather Information", "090-04 Voice Communication Failure", "090-05 VHF Propagation and Allocation of Frequencies", "090-07 Other Communications"]
};

const STORAGE_KEY = "rory_atpl_tracker_v2"; // bumped version
...
function loadState() {
  ...
  if (raw) {
    try {
      ...
      console.error("State parse error, resetting state", e);
      state = { subtopics: {}, studyDays: [], events: {}, weeklyGoal: null, weeklyMastered: 0, streak: 0, lastStudyDate: null };
      saveState();
    }
  }
...
function updateStreak() {
  ...
  const diffDays = daysBetweenUTC(last, today);
